...
var _shibes = _interopRequireDefault(require("./shibes"));

/* eslint-disable no-undef */
describe('Test shibes router', function () {
  var app = (0, _express["default"])();
  app.use(_shibes["default"]);
  it('should get 3 shibes',
  /*#__PURE__*/
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _supertest["default"])(app).get('/shibes').query({
              protocol: 'http',
              count: 3
            }).expect(200);
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0, _supertest["default"])(app).get('/shibes').expect(400);
